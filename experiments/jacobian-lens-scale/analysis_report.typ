...
#text(fill: gray)[20 prompts de 110-158 tokens (`prompts_long.txt`), mêmes bras, même estimateur ; positions ≥ 1, dernière couche exclue. Modèles : gemma-3-270m, gemma-3-4b, gemma-3-4b-it, gemma-3-12b, qwen3.5-9b-pt.]
...
#table(columns: 6, stroke: 0.3pt + gray, inset: 4pt, align: center, [*modèle*], [*prompts*], [*pic pos 1-5*], [*pic pos 40-59*], [*tardif > précoce*], [*IC95 écart*],
  [gemma-3-270m], [20], [0.51], [0.76], [11/20], [[ 0.07,  0.36]],
  [gemma-3-4b], [20], [0.98], [1.32], [10/20], [[ 0.03,  0.59]],
  [gemma-3-4b-it], [20], [0.60], [0.90], [12/20], [[ 0.16,  0.48]],
  [gemma-3-12b], [20], [1.32], [2.26], [14/20], [[ 0.35,  1.26]],
  [qwen3.5-9b-pt], [20], [1.17], [1.35], [12/20], [[ 0.01,  0.34]],
)
== Heatmaps profondeur × position
#grid(columns: (1fr, 1fr), gutter: 4pt, fig("figures/heatmap_gemma-3-4b_long.png", 100%), fig("figures/heatmap_gemma-3-4b-it_long.png", 100%), fig("figures/heatmap_gemma-3-12b_long.png", 100%), fig("figures/heatmap_qwen3.5-9b-pt_long.png", 100%))
#pagebreak()
